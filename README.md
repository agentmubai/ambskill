...
你不需要先会写 skill。课和访谈交给北冥，做成用来判断、辅导的 IP 分身；朋友圈、口播、直播稿、文章交给庖丁，做成能干活、能落地的技能。

| 真实处境 | 走哪套 | 你会得到 |
| --- | --- | --- |
| 自己是 IP，方法在课里，要一个能替自己判断的分身 | 北冥 | IP 分身，用来判断、辅导 |
| 喜欢某个老师、买过他的课，想边学边问 | 北冥 | 老师的 IP 分身，用来学习落地 |
| 收了一批喜欢的人的朋友圈、口播、直播稿或文章，想按那个路数出一条 | 庖丁 | 能干活、能落地的成稿技能 |
...
拆什么出什么：朋友圈、口播、直播稿、文章，各出能按那个路数干活的技能。想自己一步步跑，见 [庖丁说明](skills/amb-paoding/README.md)。
